...
public class FlyWeightFactory {
    ...
    static {
        ...
        registry.put(TipForma.TRIUNGHI, new FormaGeometrica(TipForma.TRIUNGHI, "Triunghi echilateral cu latura de 10 cm."));
    }

    public static FormaGeometrica getFormaGeometrica(TipForma key) {
        // Pentru ca folosim ENUM presupunem ca sigur exista in mapa noastra obiectul cautat
